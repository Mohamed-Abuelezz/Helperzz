    ...
    justify-content: center  }
      ...
      <nav class="nav-screen">
          <div class="items container">
              ...
              <ul>
                  <li> <a
                          href="{{ route('home') }}">{{ Config::get('app.locale') == 'ar' ? 'الرئيسية' : 'Home' }}</a>
                  </li>
              ...
              <ul>
                  <li class="position-relative profileImage" data-bs-container="body" data-bs-toggle="popover"
...
<a
                  ...
                  <a href="{{ route('favourites')}}">{{Config::get('app.locale') == 'ar' ?  'المفضلة' : 'Favourites'}} </a>
                  <a href="{{ route('myreservations')}}">{{Config::get('app.locale') == 'ar' ?  'حجوزاتي' : 'My Reservations'}} </a>
                  <a href="{{ route('account')}}">{{Config::get('app.locale') == 'ar' ?  'حسابي' : 'My Account'}}</a>
