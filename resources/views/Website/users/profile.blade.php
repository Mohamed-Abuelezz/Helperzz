...
<body dir="{{ Config::get('app.locale') == 'ar' ? 'rtl' : 'ltr' }}" lang="{{ Config::get('app.locale') }}">
    ...
    <section>
        <div class="info d-none d-lg-flex container">
            ...
            <div class="personDataDiv">
                ...
                <div class="personData">
                    <img src="{{ asset('storage/' . $serviceProvider->image) }}" alt="">
            ...
            <div class="otherDataDiv"
                ...
                <div class="sendButton">
                    <a data-bs-toggle="modal" href="#termsModal" class="button_1_style" style="background-color: gold">
        ...
        <div class="infoMobile d-flex d-lg-none container">
            ...
            <div class="sendButton">
                <a data-bs-toggle="modal" href="#termsModal" class="button_2_style">
                    {{ Config::get('app.locale') == 'ar' ? 'حجز' : 'Reservation' }}</a>
            </div>

            <br>

            <div class="shareButton2" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom">
            ...
            @if ($serviceProvider->lat != null)
                <div class="location">
                    <a data-bs-toggle="modal" data-bs-target="#staticBackdropMap"> <img
                            src="{{ asset('Website_Assets/assets/icons/google-maps-icon-3d-24.jpg') }}" width="30"
                            alt=""></a>
            ...
            <div class="reportButton">
                <a class="" data-bs-toggle="modal" href="#reportModal"><i class="fas fa-flag"></i></a>
            </div>
        ...
        <div class="Comments  container">
            ...
            <div class="peopleComments">
                ...
                @if ($serviceProvider->comments->sortByDesc('created_at')->isEmpty() == true)
                    <h6 class="text-center" id="nocomment"> {{ Config::get('app.locale') == 'ar' ? ' لاتوجد تعليقات 😥 ' : 'No Comments 😥' }}</h6>
                @else
                    @foreach ($serviceProvider->comments->sortByDesc('created_at') as $comment)
                        <div class="card mb-3" style="max-width: 100%;">
                            <div class="row  ">
                                <div class="col-12 col-lg-1">
                                    <img src="{{ $comment->user->image != null? asset('storage/' . $comment->user->image): asset('Website_Assets/assets/images/userImageDefault.png') }}"
                                ...
                                <div class="col-12 col-lg-10">
                                    ...
                                    @if (App\Models\ReportComment::where('serviceProvider_id',  $serviceProvider->id)
                                    ->where('comment_id',  $comment->id)->first() == null )
                                       <div class="reportCommentButton" data-id="{{$comment->id}}">
                                        <a  class=""  data-bs-toggle="modal" href="#reportCommentModal"><i class="fas fa-flag text-danger" ></i></a>
                                    </div>                                          
                                    @endif
                              
                                    @endif
                                        <p class="card-text text-center text-lg-start comment" style="font-weight: bold"> {{ $comment->comment }}
            ...
            <div class="sendComment">
                ...
                <div class="field">
                    <div class="">
                        <textarea class="form-control shadow-none custome-textFiled" id="commentInput" rows="4"></textarea>
                        {{-- <div class="form-text">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control shadow-none custome-textFiled textarea1  @error('desc') is-invalid @enderror" id="reportInput"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1 " class="form-label">
                                {{ Config::get('app.locale') == 'ar' ? 'وصف المشكلة' : 'Description of the problem' }}</label>
                            <textarea class="form-control shadow-none custome-textFiled  textarea2 @error('desc') is-invalid @enderror" id="reportCommentInput"
                                maxlength="500" rows="3" name="desc"></textarea>
                                <div id="the-count2">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control shadow-none custome-textFiled  textarea3 @error('desc') is-invalid @enderror" id="reservationInput"
                                maxlength="500" rows="3" name="desc"></textarea>
                                <div id="the-count3">
