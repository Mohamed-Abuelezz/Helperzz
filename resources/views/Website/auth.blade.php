        ...
        <div class="auth container-lg " >
            ...
            <div class="taps " >
                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    ...
                    <li class="" role="presentation">
                        <a class="btn {{ empty($errors->provider->all()) ? '' : 'active' }}" id="pills-provider-tab"
                            data-bs-toggle="pill" data-bs-target="#pills-provider" type="button" role="tab"
                            aria-controls="pills-provider" aria-selected="false">
                            ...
                            <div class="container">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview"
                                            style="background-image: url({{ asset('Website_Assets/assets/images/userImageDefault.png') }});">
                                        </div>
                                    </div>
                    ...
                    <form method="POST" action="{{ route('auth.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="fields">
                            ...
                            <div class="container">
                                <div class="avatar-upload">
                                    <div class="avatar-edit">
                                        <input type='file' class="form-control @error('image', 'provider') is-invalid @enderror" id="imageUploadProvider" name="image" accept=".png, .jpg, .jpeg" />
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreviewProvider"
                                            style="background-image: url(https://cdn.iconscout.com/icon/free/png-256/user-1648810-1401302.png);">
                                        </div>
                                            ...
                                            <select
                                                ...
                                                @foreach ($serviceCatogries as $serviceCatogrey)
                                                    <option value="{{ $serviceCatogrey->id }}"
                                                        {{ old('service_department') == $serviceCatogrey->id ? 'selected' : '' }}>
