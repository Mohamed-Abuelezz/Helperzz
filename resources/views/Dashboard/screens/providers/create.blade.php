    ...
    <div class="content-wrapper d-flex justify-content-center flex-column">
            ...
            <div class="content-header">
              <div class="container-fluid">
                  <div class="row mb-2">
                      <div class="col-sm-6">
                          <h1 class="m-0">اضافة مقدم خدمة</h1>
                      </div><!-- /.col -->
                      <div class="col-sm-6">
        ...
        <div class="container">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">اضافة مقدم خدمة</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1"
                                placeholder="الاسم" name="name" value="{{ old('name') }}"> 
                                @error('name')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">المحفظة #اختياري</label>
                            <input type="number" class="form-control @error('wallet') is-invalid @enderror" id="exampleInputPassword1"
                                placeholder="المحفظة" name="wallet"    value="{{ old('wallet') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control  @error('bio') is-invalid @enderror" id="exampleFormControlTextarea1" name="bio" rows="3"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lat') is-invalid @enderror" id="exampleInputEmail1"
                                placeholder="Enter lat" name="lat" value="{{ old('lat') }}"> 
                                @error('lat')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lng') is-invalid @enderror" id="exampleInputEmail1"
                                placeholder="Enter lng" name="lng" value="{{ old('lng') }}"> 
                                @error('lng')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">صورة البطاقة الشخصية</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input  @error('idCard') is-invalid @enderror"
                                        id="exampleInputFile" name="idCard" value="{{ old('idCard') }}">
                                    <label class="custom-file-label" for="exampleInputFile">صورة البطاقة الشخصية</label>
                                </div>
                                @error('idCard')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select @error('serviceCatogrey') is-invalid @enderror"     value="{{ old('serviceCatogrey') }}" name="serviceCatogrey" id="serviceCatogrey">

                                @foreach ($servicesCatogries as $serviceCatogrey)
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select @error('specialization') is-invalid @enderror"     value="{{ old('specialization') }}" name="specialization" id="specialization">
              ...
              <!-- /.col -->
              <div class="form-group">
                <label>خدمات اضافية  #اختياري</label>
                <select class="select2" multiple="multiple" name="moreServices[]" id="moreServices"    data-placeholder="خدمات اضافية"
                        ...
                        <div class="form-group">
                            <label>البلد</label>
                            <select class="custom-select @error('country') is-invalid @enderror"     value="{{ old('country') }}" name="country" id="country">
                        ...
                        <div class="form-group">
                            <label>المنطقه</label>
                            <select class="custom-select @error('state') is-invalid @enderror"     value="{{ old('state') }}"  name="state" id="state">
                            </select>
                            @error('state')
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <label>المدينة</label>
                            <select class="custom-select @error('city') is-invalid @enderror"     value="{{ old('city') }}"   name="city" id="cities">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio1" value="1"
                                    name="gender" {{ old('gender') == 1 ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="customRadio2" value="0"
                                    name="gender" {{ old('gender') == 0 ? 'checked' : '' }}>
