...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"> شروط قبول الخدمة </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">AcceptOrderConditions</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="{{ route('termsAndConditionsAcceptOrder.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @foreach ($acceptOrderConditions as $acceptOrderCondition)
                            <tr  data-id="{{$acceptOrderCondition->id}}">
                                <td>{{ $acceptOrderCondition->id }}</td>
                                <td>{{ $acceptOrderCondition->describe_ar }}</td>


                                <td class="d-flex flex-row justify-content-center g-5"  style="gap: 10px">


                                  <a href="#" id="delete" class="delete" style="color: red;" data-id="{{$acceptOrderCondition->id}}" data-resource="termsAndConditionsAcceptOrder/{{$acceptOrderCondition->id}}"><i class="fas fa-trash"></i> </a>
                                 
                                </td>
                                <td>{{ $acceptOrderCondition->created_at }}</td>
                            </tr>
                        @endforeach
    ...
    <script src="{{ asset('Dashboard_Assets/dist/js/pages/termsAndConditionsOrder.js') }}"></script>
