    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">شروط انشاء خدمة</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{route('Dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">MakeOrderConditions</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="{{ route('termsAndConditionsOrder.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @foreach ($ordersCondition as $orderCondition)
                            <tr  data-id="{{$orderCondition->id}}">
                                <td>{{ $orderCondition->id }}</td>
                                <td>{{ $orderCondition->describe_ar }}</td>


                                <td class="d-flex flex-row justify-content-center g-5"  style="gap: 10px">


                                  <a href="#" id="delete" class="delete" style="color: red;" data-id="{{$orderCondition->id}}" data-resource="termsAndConditionsOrder/{{$orderCondition->id}}"><i class="fas fa-trash"></i> </a>
                                 
                                </td>
                                <td>{{ $orderCondition->created_at }}</td>
                            </tr>
                        @endforeach
