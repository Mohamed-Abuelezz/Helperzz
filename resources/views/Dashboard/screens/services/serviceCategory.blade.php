...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="{{ route('servicesCategories.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="exampleInputFile">الصورة </label>
                            </div>
                            @error('image')
                            <div class="invalid-feedback">
                ...
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @foreach ($serviceCatogries as $serviceCatogrey)
                            <tr  data-id="{{$serviceCatogrey->id}}">
                                <td>{{ $serviceCatogrey->id }}</td>
                                <td>{{ $serviceCatogrey->name_ar }}</td>

                                <td><img src="{{ asset('storage/'.$serviceCatogrey->image) }}" alt="user image" width="100" height="100"> </td>
                                ...
                                <td class="d-flex flex-row justify-content-center g-5"  style="gap: 10px">
                                      ...
                                      <div class="form-group">
                                        <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                          <input type="checkbox" class="custom-control-input myActiveSwitch" data-id="{{$serviceCatogrey->id}}" data-resource="servicesCategories/{{$serviceCatogrey->id}}" id="customSwitch{{$serviceCatogrey->id}}" {{ $serviceCatogrey->isActive == 1 ? 'checked' : '' }}>
                                          <label class="custom-control-label " for="customSwitch{{$serviceCatogrey->id}}"></label>
                                        </div>
                                      </div>

                                  <a href="#" id="delete" class="delete" style="color: red;" data-id="{{$serviceCatogrey->id}}" data-resource="servicesCategories/{{$serviceCatogrey->id}}"><i class="fas fa-trash"></i> </a>
                                 
                                </td>
                                <td>{{ $serviceCatogrey->created_at }}</td>
                            </tr>
                        @endforeach
    ...
    <script src="{{ asset('Dashboard_Assets/dist/js/pages/serviceCategory.js') }}"></script>
